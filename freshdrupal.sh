...
drush pm-download ctools coffee entity devel views admin_menu token libraries module_filter globalredirect rules search_krumo features strongarm diff fpa addanother backup_migrate -y

# Enable those modules.
drush pm-enable ctools coffee page_manager entity devel devel_generate views views_ui admin_menu admin_menu_toolbar token libraries module_filter globalredirect rules rules_admin search_krumo features strongarm diff fpa addanother backup_migrate -y
